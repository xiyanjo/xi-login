...
(function(C) {
    ...
    function q(a, b, d) {
        ...
        if (a)
            ...
            c = 0;
            for (e = a.length; c < e; c++)(f || c in a) && b.call(d, a[c], c, a) } else if (a.forEach && a.forEach !== q) a.forEach(b, d, a);
        else if (sc(a))
    ...
    function pa(a, b) {
        function d(a, b) {
            var d = b.$$hashKey,
                e;
            if (L(a)) { e = 0;
                for (var f = a.length; e < f; e++) b.push(c(a[e])) } else if (sc(a))
    ...
    function ce(a, b) {
        var d = b; "string" === typeof a && "$" === a.charAt(0) && "$" === a.charAt(1) ? d = void 0 : Va(b) ? d = "$WINDOW" : b && C.document === b ? d = "$DOCUMENT" : Ya(b) && (d = "$SCOPE");
        return d }
    ...
    function yc(a, b) { a = a.replace(de, "");
    ...
    function fe(a, b) {
        ...
        q(Na, function(b) { b += "app";
            var e;!d && (e = a.querySelector("[" + b.replace(":", "\\:") + "]")) && (d = e, c = e.getAttribute(b)) });
    ...
    function Bc(a, b, d) {
        ...
        ca.resumeBootstrap = function(a) { q(a, function(a) { b.push(a) });
            return c() };
        z(ca.resumeDeferredBootstrap) && ca.resumeDeferredBootstrap()
    }

    function ge() { C.name = "NG_ENABLE_DEBUG_INFO!" + C.name;
        C.location.reload() }

    function he(a) { a = ca.element(a).injector();
        if (!a) throw xa("test");
        return a.get("$$testability") }

    function Cc(a, b) { b = b || "_";
    ...
    function Pa(a, b, d) { d && L(a) && (a = a[a.length - 1]);
        ...
        return b(a, "module", function() {
            ...
            return function(f, g, h) {
                ...
                return b(a, f, function() {
                    function a(b, d, e, f) { f || (f = c);
                        return function() { f[e || "push"]([b, d, arguments]);
                            return R } }

                    function b(a,
                        d) {
                        return function(b, e) { e && z(e) && (e.$$moduleName = f);
    ...
    function ia(a, b) {
        if (L(a)) { b = b || [];
            for (var d = 0, c = a.length; d < c; d++) b[d] = a[d] } else if (D(a))
            for (d in b = b || {}, a)
    ...
    function db(a) {
        return a.replace(Kf, function(a, d, c, e) {
            return e ? c.toUpperCase() : c }).replace(Lf, "Moz$1") }

    function Nc(a) { a = a.nodeType;
        return 1 === a || !a || 9 === a }
    ...
    function Cb(a, b, d) { 9 == a.nodeType && (a = a.documentElement);
        for (b = L(b) ? b : [b]; a;) {
    ...
    function Hf() { this.$get = function() {
            return S(O, { hasClass: function(a, b) { a.attr && (a = a[0]);
    ...
    function Wc(a) { a = (Function.prototype.toString.call(a) + " ").replace(Vf, "");
    ...
    function cb(a, b) {
        ...
        var k = {},
            ...
            p = n.$injector = h(n, function(a, b) { ca.isString(b) && l.push(b);
    ...
    function Xe() {
        ...
        this.$get = ["$window",
            ...
            function(b, d, c) {
                ...
                var h = b.document;
                a && c.$watch(function() {
                    return d.hash() }, function(a, b) { a === b && "" === a || Qf(function() { c.$evalAsync(g) }) });
                return g
            }
        ]
    }
    ...
    function $f(a, b, d, c) {
        ...
        var r, J, v = l.href,
            ...
            K = c.history ? function() {
                try {
                    return m.state } catch (a) {} } :
            A;
        g();
        J = r;
        k.url = function(b, d, e) { y(e) && (e = null);
            ...
            if (b) {
                ...
                var h = v && Ja(v) === Ja(b);
                v = b;
                J = e;!c.history || h && f ? (h || (t = b), d ? l.replace(b) : h ? (d = l, e = b.indexOf("#"), e = -1 === e ? "" : b.substr(e), d.hash = e) : l.href = b, l.href !== b && (t = b)) : (m[d ? "replaceState" : "pushState"](e, "", b), g(), J = r);
                t && (t = b);
                return k }
    ...
    function Bf() { this.$get = ["$cacheFactory", function(a) {
            return a("templates") }] }
    ...
    function Fc(a, b) {
            ...
            function c(a) {
                function e(b) {
                    return z(b) || L(b) ? function(c, d) {
                        return a.invoke(b, this, { $element: c, $attrs: d }) } : b }
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, e, n, t, K, M, H, E) {
            ...
            function P(a, b, c) { pa.innerHTML = "<span " + b + ">";
            ...
            function s(a, b, c, d, e, f) {
                ...
                for (var h = [], k, l, m, p, n, r = 0; r < a.length; r++) { k = new Da;
            ...
            function Zc(a, b, c) {
                return function(d, e, f, g, h) { e = N(e[0], b, c);
                    return a(d, e, f, g, h) } }
            ...
            function oa(a, b, d, e, f, g, h, k, l) {
                ...
                for (var n = -Number.MAX_VALUE,
                    ...
                    if (!Fa && (x.replace && (x.templateUrl || x.template) || x.transclude &&
                            !x.$$tlb)) {
                        for (w = A + 1; Fa = a[w++];)
                            if (Fa.transclude && !Fa.$$tlb || Fa.replace && (Fa.templateUrl || Fa.template)) { za = !0;
                                break }
                        Fa = !0 }!x.templateUrl && x.controller && (w = x.controller, v = v || U(), X("'" + I + "' controller", v[I], x, t), v[I] = x);
                    if (w = x.transclude)
                    ...
                    if (x.templateUrl) B = !0, X("template", H, x, t), H = x, x.replace && (g = x), p = ba(a.splice(A, a.length - A), t, d, f, M && K, h, k, { controllerDirectives: v, newScopeDirective: r !== x && r, newIsolateScopeDirective: u, templateDirective: H, nonTlbTranscludeDirective: E }),
                        C = a.length;
                    else if (x.compile) try { s = x.compile(t, d, K);
                        var Y = x.$$originalDirective || x;
                        z(s) ? m(null, ab(Y, s), G, hb) : s && m(ab(Y, s.pre), ab(Y, s.post), G, hb) } catch (ca) { c(ca, ya(t)) }
                    ...
                    switch (e.mode) {
                        ...
                        case "=":
                            ...
                            H = u.literal ? na : function(a, b) {
                                return a === b || a !== a && b !== b };
                            x = u.assign || function() { v = d[h] = u(a);
                                throw ga("nonassign", c[m], m, f.name); };
                            v = d[h] = u(a);
                            p = function(b) { H(b, d[h]) || (H(b, v) ? x(a, b = d[h]) : d[h] = b);
                                return v = b };
                            p.$stateful = !0;
            ...
            Da.prototype = {
                ...
                $set: function(a, b, d, e) {
                    ...
                    if ("a" === f && ("href" === a || "xlinkHref" === a) || "img" ===
                        ...
                        f += E(W(g[0]), !0);
                        2 === g.length && (f += " " + W(g[1]));
                        this[a] = b = f }!1 !== d && (null === b || y(b) ? this.$$element.removeAttr(e) : ta.test(e) ? this.$$element.attr(e, b) : P(this.$$element[0], e, b));
    ...
    function Fb(a, b) { this.previousValue = a;
        this.currentValue = b }
    ...
    function ff() {
        ...
        this.register = function(b, c) { Qa(b, "controller");
            D(b) ? S(a, b) : a[b] = c };
            ...
            function(d, c) {
                ...
                return function(f, g, h, k) {
                    ...
                    if (h) return h = (L(f) ? f[f.length - 1] : f).prototype, l = Object.create(h || null), n && e(g, n, l, m || f.name), S(function() {
                        ...
                        return l }, { instance: l, identifier: n });
    ...
    function ed(a) {
        ...
        G(a) ? q(a.split("\n"), function(a) { d = a.indexOf(":");
            ...
            a = W(a.substr(d + 1));
            e && (b[e] = b[e] ? b[e] + ", " + a : a) }) : D(a) && q(a, function(a, d) {
            var f = Q(d),
                g = W(a);
            f && (b[f] = b[f] ? b[f] + ", " + g : g) });
        return b
    ...
    function mf() {
        ...
        this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory",
            ...
            function(e, f, g, h, k, l) {
                ...
                function p(a, b) { 0 < b.length && (a += (-1 == a.indexOf("?") ? "?" : "&") + b);
                    return a }
                var u = g("$http");
                ...
                (function(a) { q(arguments, function(a) { m[a] = function(b, c, d) {
                            return m(S({}, d || {}, { method: a, url: b, data: c })) } }) })("post", "put", "patch");
                m.defaults = a;
                return m
            }
        ]
    ...
    function qf() { this.$get = function() {
            return function() {
                return new C.XMLHttpRequest } } }

    function pf() { this.$get = ["$browser", "$jsonpCallbacks", "$document", "$xhrFactory", function(a, b, d, c) {
            ...
            function(d, c, e) {
                ...
                function k(f, k, p, n) {
                            ...
                            if (n && !w(a)) d = a;
                                ...
                                switch (typeof a) {
                                    ...
                                    default:
                                        a = bb(a) }
                                d = a }
                            return d } catch (g) { c(Ka.interr(f, g)) } }
                    ...
                    for (var E = [], I = []; K < v;)
                        ...
                        else { K !== v && E.push(g(f.substring(K)));
                            break }
                    ...
                    if (!k || M.length) {
                        ...
                        return S(function(a) {
                            ...
                            try {
                                for (; b < d; b++) e[b] = H[b](a);
                                return Da(e) } catch (g) { c(Ka.interr(f, g)) }
        ...
        this.$get = ["$rootScope", "$window", "$q", "$$q", "$browser", function(a,
            ...
            function f(f, k, l, m) {
                ...
                var p = 4 < arguments.length,
                    ...
                    fa = v.promise;
                l = w(l) ? l : 0;
                fa.$$intervalId = R(function() { J ? e.defer(n) : a.$evalAsync(n);
                    v.notify(r++);
    ...
    function sf() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function(d, c, e, f, g) {
            ...
            if (b.enabled) {
                ...
                m = e.history ? gc : ld } else p = Ja(n), m = hc;
    ...
    function V(a, b) {
        ...
        switch (a.type) {
            case s.Program:
                d = !0;
                q(a.body, function(a) { V(a.expression, b);
            ...
            case s.CallExpression:
                d = a.filter ? !b(a.callee.name).$stateful :
                    !1;
                c = [];
                q(a.arguments, function(a) { V(a, b);
                    d = d && a.constant;
    ...
    function pd(a) {
        if (1 == a.length) { a = a[0].expression;
            var b = a.toWatch;
    ...
    function uf() {
        ...
        this.setIdentifierFns = function(a, b) { c = a;
            e = b;
            return this };
        this.$get = ["$filter", function(f) {
            ...
            function u(a, b) {
                ...
                var c = a.$$watchDelegate,
                    d = !1,
                    c = c !== n && c !== m ? function(c, e, f, g) { f = d && g ? g[0] : a(c, e, f, g);
                        return b(f, c, e) } : function(c, d, e, f) {
                        e = a(c,
                            d, e, f);
                        c = b(e, c, d);
                        return w(e) ? c : e
    ...
    function xf() { this.$get = ["$browser", "$exceptionHandler", function(a, b) {
    ...
    function vf() {
        ...
        this.$get = ["$exceptionHandler", "$parse", "$browser", function(f, g, h) {
            ...
            function l(a) { 9 === Ea && (a.$$childHead && l(a.$$childHead), a.$$nextSibling && l(a.$$nextSibling));
            ...
            m.prototype = {
                ...
                $watch: function(a, b, d, e) {
                    ...
                    p(this,
                        1);
                    return function() { 0 <= Za(k, l) && p(h, -1);
                        c = null }
                },
                ...
                $watchCollection: function(a, b) {
                    ...
                    var d = this,
                        ...
                        r = !0,
                        u = 0;
                    return this.$watch(m, function() { r ? (r = !1, b(e, e, d)) : b(e, h, d);
                        if (k)
                            if (D(e))
                                if (ta(e)) { h = Array(e.length);
                ...
                $eval: function(a, b) {
                    return g(a)(this, b) },
                $evalAsync: function(a, b) { J.$$phase || v.length || h.defer(function() { v.length && J.$digest() });
                    v.push({ scope: this, expression: g(a), locals: b }) },
                $$postDigest: function(a) { w.push(a) },
                $apply: function(a) {
                    try { n("$apply");
                        try {
                            return this.$eval(a) } finally { J.$$phase = null } } catch (b) { f(b) } finally {
                ...
                $broadcast: function(a, b) {
                    ...
                    for (var g = $a([e], arguments, 1), h, k; c = d;) { e.currentScope = c;
                        d = c.$$listeners[a] || [];
                        h = 0;
    ...
    function zf() {
        ...
        var a = ["self"],
            b = [];
        this.resourceUrlWhitelist = function(b) { arguments.length && (a = xd(b));
            return a };
        this.resourceUrlBlacklist = function(a) { arguments.length && (b = xd(a));
            return b };
    ...
    function Af() {
        this.$get = ["$window", "$document", function(a, b) {
            ...
            if (l) {
                ...
                n = !!("animation" in l || h + "Animation" in l);!e || m && n || (m = G(l.webkitTransition), n = G(l.webkitAnimation)) }
        ...
        this.$get = ["$templateCache", "$http", "$q", "$sce", function(b, d, c, e) {
            function f(g, h) {
                ...
                L(k) ? k = k.filter(function(a) {
                    return a !== dc }) : k === dc && (k = null);
                return d.get(g, S({ cache: b, transformResponse: k }, a))["finally"](function() { f.totalPendingRequests-- }).then(function(a) { b.put(g, a.data);
    ...
    function Df() {
        this.$get = ["$rootScope", "$browser", "$location", function(a, b, d) {
            return {
                findBindings: function(a, b, d) { a = a.getElementsByClassName("ng-binding");
                    var g = [];
                    q(a, function(a) {
    ...
    function Ad(a) {
        var b =
            a.NUMBER_FORMATS;
        return function(a, c, e) { y(c) && (c = b.CURRENCY_SYM);
    ...
    function xg(a, b, d, c) {
        ...
        d = b + a.i;
        c = e[d];
        if (0 < d) { e.splice(Math.max(a.i, d));
            for (var g = d; g < e.length; g++) e[g] = 0 } else
    ...
    function ba(a, b, d, c, e) { d = d || 0;
        return function(f) { f = f["get" + a]();
            if (0 < d || f > -d) f += d;
            0 === f && -12 == d && (f = 12);
            return Kb(f, b, c, e) } }
    ...
    function Dd(a) {
        ...
        function c(a, b) {
            ...
            if (d === k) {
                var k = a.value,
                    l = b.value; "string" === d ? (k = k.toLowerCase(), l = l.toLowerCase()) : "object" === d && (D(k) && (k = a.index), D(l) && (l = b.index));
                k !== l && (c = k < l ? -1 : 1) } else c = d < k ? -1 : 1;
            return c }
    ...
    function Jd(a, b, d,
        ...
        f.$addControl = function(a) { Qa(a.$name, "input");
            g.push(a);
            a.$name && (f[a.$name] = a);
            a.$$parentForm = f };
        ...
        Kd({ ctrl: this, $element: a, set: function(a, b, c) {
                ...
                var d = a[b];
                d && (Za(d, c), 0 === d.length && delete a[b]) }, $animate: c });
        f.$setDirty = function() {
            c.removeClass(a, Ua);
            c.addClass(a,
                Mb);
        ...
        f.$setPristine = function() { c.setClass(a, Ua, Mb + " ng-submitted");
            f.$dirty = !1;
            f.$pristine = !0;
            f.$submitted = !1;
    ...
    function pc(a) { a.$formatters.push(function(b) {
    ...
    function lb(a, b, d, c, e, f) {
        ...
        var k, l = function(a) { k && (f.defer.cancel(k), k = null);
            if (!h) {
                var e = b.val();
                a = a && a.type; "password" === g || d.ngTrim && "false" === d.ngTrim || (e = W(e));
                (c.$viewValue !== e || "" === e && c.$$hasNativeValidators) && c.$setViewValue(e, a) } };
        if (e.hasEvent("input")) b.on("input", l);
        else {
            var m = function(a, b, c) { k || (k = f.defer(function() { k = null;
                    b && b.value === c || l(a) })) };
    ...
    function mb(a, b, d, c) {
        return function(e, f, g, h, k, l, m) {
            ...
            if (w(g.max) || g.ngMax) {
                ...
                g.$observe("max", function(a) { r = p(a);
                    h.$validate() }) }
        }
    }
        ...
        Ba = function() {
            if (!w(Ba.rules)) {
                ...
                if (a) {
                    ...
                    Ba.rules = { noUnsafeEval: !b || -1 !== b.indexOf("no-unsafe-eval"), noInlineStyle: !b || -1 !== b.indexOf("no-inline-style") } } else { a = Ba;
    ...
    q({ data: Yb, removeData: eb, hasData: function(a) {
            ...
            for (var b = 0, d = a.length; b < d; b++) eb(a[b]) } }, function(a, b) { O[b] = a });
    q({
        data: Yb,
        inheritedData: Cb,
        scope: function(a) {
    ...
    q({
        ...
        replaceWith: function(a, b) {
            ...
            wb(a);
            q(new O(b), function(b) { d ? c.insertBefore(b, d.nextSibling) : c.replaceChild(b, a);
                d = b }) },
        children: function(a) {
            var b = [];
    ...
    }, function(a, b) { O.prototype[b] = function(b, c, e) {
    ...
    var If = [function() { this.$get = [function() {
                return Ra }] }],
        Wf = /^([^\(]+?)=>/,
        Xf = /^[^\(]*\(\s*([^\)]*)\)/m,
        Eg = /,/,
    ...
    var Rd = N("$animate"),
        ...
        af = function() {
            ...
            this.$get = ["$$AnimateRunner", "$rootScope", function(d, c) {
                ...
                return { enabled: A, on: A, off: A, pin: A, push: function(g, h, k, l) { l && l();
                        k = k || {};
                        k.from && g.css(k.from);
                        k.to && g.css(k.to);
        ...
        Ye = ["$provide", function(a) {
            ...
            this.$get = ["$$animateQueue", function(a) {
                ...
                return {
                    ...
                    enter: function(e, f, g, h) { f = f && F(f);
                        g = g && F(g);
                        f = f || g.parent();
                        b(e, f, g);
                        return a.push(e, "enter", Ia(h)) },
                    move: function(e, f, g, h) { f = f && F(f);
                        g = g && F(g);
                        f = f || g.parent();
                        b(e, f, g);
        ...
        Ze = function() { this.$get = ["$$rAF", "$q", "$$AnimateRunner", function(a, b, d) {
                return function(b, e) {
    ...
    var Yc = /^((?:x|data)[\:\-_])/i,
        ...
        jf = function() { this.$get = ["$document", function(a) {
                return function(b) { b ? !b.nodeType && b instanceof F && (b = b[0]) : b = a[0].body;
    ...
    var rf = function() {
            this.$get = ["$window", function(a) {
                ...
                var d = a.angular.callbacks,
                    c = {};
                return {
                    createCallback: function(a) { a = "_" + (d.$$counter++).toString(36);
    ...
    q([ld, hc, gc],
        function(a) { a.prototype = Object.create(Ig);
            ...
            if (!f && w(a.watchId)) b =
                ...
                case s.ObjectExpression:
                    ...
                    n ? (b = b || this.nextId(), this.assign(b, "{}"), q(a.properties, function(a) { a.computed ? (g = k.nextId(), k.recurse(a.key, g)) : g = a.key.type === s.Identifier ? a.key.name : "" + a.key.value;
                        h = k.nextId();
                        k.recurse(a.value, h);
                        k.assign(k.member(b, g, a.computed), h) })) : (q(a.properties, function(b) {
                        k.recurse(b.value,
    ...
    ud.prototype = {
            ...
            switch (a.type) {
                ...
                case s.CallExpression:
                    return g = [], q(a.arguments, function(a) { g.push(f.recurse(a)) }), a.filter && (e = this.$filter(a.callee.name)), a.filter || (e = this.recurse(a.callee, !0)), a.filter ? function(a, c, d, f) {
                        ...
                        var n = e(a, c, d, m),
                            p;
                        if (null != n.value) { ra(n.context, f.expression);
        ...
        nonComputedMember: function(a, b, d, c, e, f) {
            return function(g, h, k, l) { g = a(g, h, k, l);
    ...
    var Xd = {
            ...
            number: function(a, b, d, c, e, f) {
                ...
                if (w(d.min) || d.ngMin) {
                    ...
                    d.$observe("min", function(a) { w(a) && !T(a) && (a = parseFloat(a));
                ...
                if (w(d.max) || d.ngMax) {
                    ...
                    d.$observe("max", function(a) { w(a) && !T(a) && (a = parseFloat(a));
            ...
            radio: function(a, b, d, c) { y(d.name) && b.attr("name", ++pb);
        ...
        ue = ["$compile", function(a) {
            return { restrict: "AC", compile: function(b) { a.$$addBindingClass(b);
                    return function(b, c, e) { a.$$addBindingInfo(c, e.ngBind);
                        c = c[0];
        ...
        ze = qc("Odd", 0),
        ye = qc("Even", 1),
        Ae = Ta({ compile: function(a, b) { b.$set("ngCloak", void 0);
    ...
    var Ee = ["$animate", "$compile", function(a, b) {
                        ...
                        c.$watch(f, function(f) {
                            ...
                            f ? (a(f, !0).then(function(a) {
                                if (!c.$$destroyed && t === q) {
                                    ...
                                    c.$eval(g) } }, function() { c.$$destroyed || t !== q || (y(), c.$emit("$includeContentError", f)) }), c.$emit("$includeContentRequested", f)) : (y(), n.template = null) })
                    }
                }
            }
        }],
        ...
        Pg = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(a, b, d, c, e, f, g, h, k, l) {
            ...
            this.$setDirty = function() { r.$dirty = !0;
                r.$pristine = !1;
                f.removeClass(c, Ua);
                f.addClass(c, Mb);
                r.$$parentForm.$setDirty() };
            this.$setUntouched = function() { r.$touched = !1;
                r.$untouched = !0;
                f.setClass(c, "ng-untouched", "ng-touched") };
            this.$setTouched = function() { r.$touched = !0;
                r.$untouched = !1;
                f.setClass(c, "ng-touched", "ng-untouched") };
            this.$rollbackViewValue = function() { g.cancel(s);
            ...
            this.$$writeModelToScope = function() { u(a, r.$modelValue);
                q(r.$viewChangeListeners, function(a) {
                    try { a() } catch (c) { b(c) } }) };
            this.$setViewValue = function(a, b) { r.$viewValue = a;
            ...
            return {
                ...
                controller: ["$scope", "$attrs", function(a, b) {
                    ...
                    w(this.$options.updateOn) ? (this.$options.updateOnDefault = !1, this.$options.updateOn = W(this.$options.updateOn.replace(Qg,
                        function() { d.$options.updateOnDefault = !0;
                ...
                link: {
                    ...
                    post: function(d, h, k, l) {
                        ...
                        y ? (s.$isEmpty = function(a) {
                            return !a || 0 === a.length }, p.writeValue = function(a) { t.items.forEach(function(a) { a.element.selected = !1 });
                            a && a.forEach(function(a) {
                                if (a = t.getOptionFromViewValue(a)) a.element.selected = !0 }) }, p.readValue = function() {
                            var a = h.val() || [],
                                b = [];
                            q(a, function(a) {
                                (a =
                            ...
                            if (L(s.$viewValue)) return s.$viewValue.map(function(a) {
                                return K.getTrackByValue(a) }) }, function() { s.$render() })) : (p.writeValue = function(a) {
                            ...
                            return a && !a.disabled ? (v || B.remove(), z.remove(), t.getViewValueFromOption(a)) : null }, K.trackBy && d.$watch(function() {
                            return K.getTrackByValue(s.$viewValue) }, function() { s.$render() }));
        ...
        Ne = Ta({ transclude: "element", priority: 1200, require: "^ngSwitch", multiElement: !0, link: function(a, b, d, c, e) { c.cases["!" + d.ngSwitchWhen] = c.cases["!" + d.ngSwitchWhen] || [];
        ...
        Vg = ["$element", "$scope", function(a, b) {
            ...
            d.renderUnknownOption = function(b) { b = "? " + Ca(b) + " ?";
            ...
            d.addOption = function(a, b) {
                if (8 !== b[0].nodeType) { Qa(a, '"option value"'); "" === a && (d.emptyOption = b);
                    var g = c.get(a) || 0;
                    c.put(a, g + 1);
            ...
            d.registerOption = function(a, b, c, h, k) {
                if (h) {
                    var l;
                    c.$observe("value", function(a) { w(l) && d.removeOption(l);
                        l = a;
                        d.addOption(a, b) }) } else k ? a.$watch(k, function(a, e) { c.$set("value", a);
                    e !== a && d.removeOption(e);
                    d.addOption(a, b) }) : d.addOption(c.value, b);
                b.on("$destroy", function() { d.removeOption(c.value);
                    d.ngModelCtrl.$render() }) }
        }],
        re = function() {
            return {
                    ...
                    pre: function(a, b,
                        ...
                        if (e) {
                            ...
                            if (d.multiple) {
                                ...
                                var g, h = NaN;
                                a.$watch(function() { h !== e.$viewValue || na(g, e.$viewValue) || (g = ia(e.$viewValue), e.$render());
                                    h = e.$viewValue });
        ...
        Ic = function() {
            return {
                restrict: "A",
                require: "?ngModel",
                link: function(a, b, d, c) { c && (d.required = !0, c.$validators.required = function(a, b) {
